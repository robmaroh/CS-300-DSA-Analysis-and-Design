...
int partition(vector<Bid>& bids, int begin, int end) {
    ...
    unsigned int pivot = (begin + (end - begin) / 2);
    bool finished = false;        
    ...
    while (!finished) {
        ...
        if (low >= high) {
            finished = true;
            // if variable low is not greater than or equal to high the two bids are swapped
        }
...
int main(int argc, char* argv[]) {
    ...
    while (choice != 9) {
        ...
        case 3:
            ...
            // Call the selectionSort method to sort the loaded bids
            selectionSort(bids);
            
            // Display the number of bids read
            cout << bids.size() << " bids read." << endl;

            // Calculate the elapsed time and display the result
            ticks = clock() - ticks; // Current clock ticks minus the starting clock ticks

            // Display the time by clock ticks
            cout << "Time: " << ticks << " clock ticks." << endl;

            //Display the time by seconds
            cout << "Time: " << ticks * (1.0 / CLOCKS_PER_SEC) << " seconds." << endl;
        ...
        case 4:
            ...
            // Call the quickSort method to sort the loaded bids
